...
const ServicePromise = () => {
  return (
    <div className="max-w-360 w-full lg:px-30 md:px-10 px-4 lg:py-20 flex flex-col items-center md:gap-8">
      <h2 className="md:text-[48px] text-[35px] font-semibold md:whitespace-nowrap md:text-left text-center">Our Service Promise</h2>
      <div className="flex w-full py-10 items-center justify-center md:gap-5 gap-2">
        <Delivery />
        <Arc1 />
        <Secure />
        {/* <div className="flex lg:h-35 w-fit items-end">
          <Arc2 />
        </div> */}
      ...
      <div className="flex justify-center lg:justify-between w-full lg:px-10">
        {ServiceData.map((item, index) => (
          ...
          >
            <h3 className="lg:text-2xl text-xl font-semibold m-2">{item.heading}</h3>
