...
const Navbar = () => {
  ...
  return (
    <div className="sticky top-0 flex flex-col max-w-360 w-full z-100 ">
      <div className="w-full bg-white flex md:justify-between justify-center lg:px-30  md:px-10 py-3">
      ...
      <div className="w-full text-white font-medium text-lg bg-[rgba(1,198,181,1)] lg:px-30  px-10 flex justify-between items-center">
        <Link to={"/"}>
          <img
            src="/Images/Logo.png"
            alt=""
