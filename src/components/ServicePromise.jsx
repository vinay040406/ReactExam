...
const ServicePromise = () => {
  return (
    <div className="max-w-285 w-full lg:mt-35 md:mt-25 mt-10 2xl:px-0 px-10 flex flex-col items-center lg:gap-15 md:gap-8  gap-3">
      ...
      <div className="flex flex-col lg:gap-6.75">
        <div className="flex w-full items-center lg:justify-center justify-around md:px-0 lg:px-0 md:gap-5 md:pb-0 pb-2 gap-4 md:mt-0 mt-4">
          <Delivery />
